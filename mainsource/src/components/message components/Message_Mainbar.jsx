...
const Message_Mainbar = () => {
  return (
    <div className="w-screen h-full bg-gray-100 flex flex-col sm:flex-row">
      {/* Left Sidebar */}
        ...
        <div className="flex flex-col gap-4 px-2">
          {[...Array(10)].map((_, index) => (
            ...
            >
              ...
              <p className="text-gray-400 text-xs whitespace-nowrap z-30 right-4 absolute ">12:36 PM</p>
            </div>
          ))}
        </div>
      </div>
